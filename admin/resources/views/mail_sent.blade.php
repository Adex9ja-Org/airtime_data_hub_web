                            ...
                            <div class="aside-content">
                                ...
                                <div class="aside-nav collapse">
                                    <ul class="nav">
                                        ...
                                        <li class="active"><a href="/mail/sent"><span class="icon"><i data-feather="mail"></i></span>Sent Mail</a></li>
                        ...
                        <div class="col-lg-9 email-content">
                            <div class="email-inbox-header">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="email-title mb-2 mb-md-0"><span class="icon"><i data-feather="mail"></i></span> Sent Mails <span class="new-messages">[{{ sizeof($mails) }} sent mail(s)]</span> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="email-list">
                                @foreach($mails as $mail)
                                    <div class="email-list-item">
                                        <a href="/mail/read/{{ $mail->id }}" class="email-list-detail">
                                            <div>
